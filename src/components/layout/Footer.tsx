...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white text-black">
      <div className="container mx-auto max-w-screen-xl flex flex-col lg:flex-row justify-between items-center py-6 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-20 2xl:px-0">
        {/* Logo and Copyright */}
