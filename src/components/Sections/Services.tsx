...
const Services: React.FC = () => {
  return (
    <section id="services" className="relative bg-gray-50 overflow-hidden py-12 mt-6">
      {/* Background Images para Desktop e acima */}
      <div className="hidden sm:block">
        <BackgroundImages />
      </div>

      <div className="container mx-auto flex justify-end items-start px-4 sm:px-6 md:px-10 lg:px-20 xl:px-20 2xl:px-20 sm:text-left text-center z-10 relative h-[740px] sm:h-[650px] md:h-[680px] lg:h-[600px] xl:h-screen 2xl:h-screen mt-0 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
    ...
    <div
      className={`${
        isMobile
          ...
          : "absolute top-[-60px] sm:top-[-60px] md:top-[-60px] lg:top-[-60px] xl:top-[-60px] 2xl:top-[-60px] shadow-sm left-1/2 sm:left-10 transform -translate-x-1/2 sm:translate-x-0 z-20 sm:z-0 w-72 sm:w-48 md:w-64 lg:w-72 xl:w-96 2xl:w-96"
      }`}
    >
      <Image
